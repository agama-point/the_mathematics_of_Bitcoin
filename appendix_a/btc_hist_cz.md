...
Digitální nedůvěra v centrální autoritu

│

▼

b-money (decentralizované peníze)

│

▼

bit gold (PoW + digitální vzácnost)

│

▼

RPOW (přenositelné PoW jednotky)

│

▼

Timestamping (neměnná historie)

│

▼

Merkle trees (efektivní data)
